...
function CustomStepIcon(props: CustomStepIconType) {
...
export default function CustomizedSteppers({ activeStep, cosmetic }: CustomizedSteppersType) {
  return (
          ...
          <Step key={label}>
            <StepLabel
              StepIconComponent={(props) => (
                <CustomStepIcon {...props} active={index <= activeStep} completed={index < activeStep} icon={index + 1} />
              )}
            />
          </Step>
        ))}
